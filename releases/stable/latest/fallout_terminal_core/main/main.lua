...
local basePath = "/home/fallout_terminal_core/"
...
local function chat(type)
    if type == "recreation" then
        clearTerm()
        wait(5)
        dofile(basePath.. "/commands/recreationChat.lua")
    end
end
...
System Information:
        ...
        elseif input == "admin" then
            dofile(basePath.. "/commands/admin.lua")
        elseif input == "about" then
            dofile(basePath.. "/commands/about_print.lua")
        else
